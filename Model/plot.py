...
def plot_ave(fin):
  ...
  xs = np.array(xs)
  plt.scatter(xs, np.mean(fin['losses'], axis=1), label='Total loss', marker='o', color='pink')
  plt.scatter(xs, np.mean(fin['node_losses'], axis=1), label='Node loss', marker='o', color='pink')
  plt.scatter(xs, np.mean(fin['edge_losses'], axis=1), label='Edge loss', marker='o', color='pink')
